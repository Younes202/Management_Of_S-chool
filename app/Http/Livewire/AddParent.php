...
{
    public $successMessage = '',$show_table=true,$updateMode=false;

    public $catchError;
    public $currentStep = 1,
        $Email, $Password,
        $National_ID_Father, $Passport_ID_Father,
        $Phone_Father,$Name_Father,$Job_Father,
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName, [
            ...
            'National_ID_Father' => 'required|string|min:2|max:7',
            'Passport_ID_Father' => 'min:10|max:10',
            'Phone_Father' => 'regex:/^([0-9\s\-\+\(\)]*)$/|min:10',
            'National_ID_Mother' => 'required|string|min:2|max:7',
    ...
    public function submitForm()
    {
        ...
        try {
            ...
            $My_Parent->save();
            $this->successMessage = 'Validation avec succès';
            $this->clearForm();
            $this->currentStep = 1;
            ...
            $parent->update([
             // Update for Father
               ...
               // Update for Mother
                ...
                'Phone_Mother' => $this->Phone_Father,
