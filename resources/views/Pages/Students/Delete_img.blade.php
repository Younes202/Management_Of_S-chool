    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">Supprimer le document</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Delete_attachment')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">Attention</h5>
