...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle') Modifier une  matière
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('subjects.update','test')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title"> Nom du matière    </label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="inputState"> Cycle scolaire</label>
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState">Nom du Professeur </label>
