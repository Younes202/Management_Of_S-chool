    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">Supprimer {{$online_classe->topic}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('online_classes.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">Attention il va supprimer</h5>
